...
class MyXLNetModel(torch.nn.Module):
    ...
    def get_segments_from_one_batch(self, input_ids, token_type_ids, attention_mask):
        # Move the tensors to the correct device before any operations
...
if __name__ == '__main__':
    train_dloader = load_data('XlNet_merged_output.csv', tokenizer, shuffle=True)
    val_dloader = load_data('XlNet_merged_output_eval.csv', tokenizer)
